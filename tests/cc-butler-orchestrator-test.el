...
;; (defcustom-special) dynamic variable before the escalate_to_butler
;; kind-routing tests below `let'-bind it -- under lexical-binding, `let'
;; on an undeclared symbol binds lexically, invisibly to
;; `cc-butler-tool-escalate-to-butler' compiled in cc-butler-orchestrator.el's
;; own lexical scope.
